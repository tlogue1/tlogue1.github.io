class Tree {
    ...
    displayDetails(clickedSection) {
        const treesSection = document.getElementById("trees");
        Array.from(treesSection.children).forEach((section) => {
            if(section !== clickedSection) {
                section.querySelector(".more").classList.add("hidden");
            }
        });

        const moreSection = clickedSection.querySelector(".more");
